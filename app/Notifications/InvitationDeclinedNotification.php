...
class InvitationDeclinedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line(__('Your invitation to ', [], $notifiable->locale).' '.$this->invitation->invitedPlayer->username.' '.__(' to play a football match on ', [], $notifiable->locale).' '.$invitationDate->toDateTimeString().' '.__(' at ', [], $notifiable->locale).' '.$this->invitation->stadium->name.' '.__(' was declined.', [], $notifiable->locale))
