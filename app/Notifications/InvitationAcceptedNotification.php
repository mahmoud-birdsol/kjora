...
class InvitationAcceptedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line(__('Your invitation to ', [], $notifiable->locale).$this->invitation->invitedPlayer->username.' '.__(' to play a football match on ', [], $notifiable->locale).$invitationDate->toDateTimeString().' '.__(' at ', [], $notifiable->locale).' '.$this->invitation->stadium->name.' '.__(' was accepted.', [], $notifiable->locale))
