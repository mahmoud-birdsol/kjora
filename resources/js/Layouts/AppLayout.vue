...
<template>
    <div :dir="$page.props.locale == 'ar' ? 'rtl' : 'ltr'">
        ...
        <div class="min-h-screen bg-gradient-to-b from-black to-primaryDark  isolate before:-z-10 relative" 
        :class="!route().current('posts.show')?'before:bg-[url(/images/ballkjoura.png)]  before:absolute before:inset-0 before:bg-[center_-243px] before:bg-no-repeat before:mix-blend-overlay':''"
        >
