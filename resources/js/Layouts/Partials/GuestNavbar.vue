		...
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="flex h-16 justify-between items-center">
				...
				<div class="sm:w-1/3 sm:flex sm:justify-center sm:items-center">
					<img
						class="block h-20 mt-4 w-auto lg:hidden"
						src="/images/logo.png"
						alt="Your Company" />
					<img
						class="hidden h-20 mt-4 w-auto lg:block"
						src="/images/logo.png"
						alt="Your Company" />
				</div>

				<div
					class="hidden min-h-[2rem] sm:w-1/3 sm:ml-6 sm:flex sm:justify-end sm:gap-8">
					<NavLink
						:href="route('welcome')"
						:active="route().current('login') || route().current('welcome')">
						{{ $t('home') }}
					</NavLink>
					<NavLink
						:href="route('about')"
