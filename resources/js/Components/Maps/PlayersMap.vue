...
const filteredPlayers = props.players.data.filter(
   (p) => p.current_latitude != null || p.current_longitude != null
);
...
<template>
   <GoogleMap
      data-map="players-map"
      :api-key="apiKey"
      style="width: 100%; height: 500px"
      :center="{
         lat: parseFloat(userStore.currentUser.current_latitude),
         lng: parseFloat(userStore.currentUser.current_longitude),
      }"
      :zoom="5"
   >
