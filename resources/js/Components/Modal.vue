...
<template>
    <teleport to="body">
        <transition leave-active-class="duration-200 ">
            <div v-show="show" class="fixed inset-0 z-50 grid items-center px-4 py-6 overflow-y-auto sm:px-2" scroll-region>
                ...
                <transition enter-active-class="duration-300 ease-out" enter-from-class="translate-y-4 opacity-0 sm:translate-y-0 sm:scale-95" enter-to-class="translate-y-0 opacity-100 sm:scale-100" leave-active-class="duration-200 ease-in" leave-from-class="translate-y-0 opacity-100 sm:scale-100"
                    ...
                    <div v-show="show" class="">
                        <div v-show="position == 'center'" class="mb-6 overflow-hidden transition-all transform bg-white rounded-lg shadow-xl sm:w-full sm:mx-auto" :class="maxWidthClass">
                            ...
                            <div class="w-full mx-auto max-w-7xl">
                                <div class="flex justify-end">
                                    <div class="flex justify-center sm:w-1/2">
                                        <div class="mb-6 overflow-hidden transition-all transform bg-white rounded-lg shadow-xl sm:w-full sm:mx-auto" :class="maxWidthClass">
