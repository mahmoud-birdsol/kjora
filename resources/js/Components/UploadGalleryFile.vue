    ...
    <Modal :show="show" :max-width="maxWidth" :closeable="closeable" :position="position" @close="reset" :key="num">
        <div class=" flex flex-col min-h-[500px] justify-between p-6 pt-0">
            ...
            <div>
                ...
                <div class="mb-2 text-sm text-red-700">{{ $t('upload :filesData from :maximumUploadNumberOfFiles', {filesData: filesData.length , maximumUploadNumberOfFiles:maximumUploadNumberOfFiles}) }}</div>
