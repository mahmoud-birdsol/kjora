...
<!--                                    score-template="{value}"/>-->
                                <span class="flex items-center gap-1">
                                    <template v-for="i in 5">
                                        <StarIconFilled class="h-5 w-5" v-if="player.rating >= i" />
                                        <StarIconOutline class="h-5 w-5 text-white" v-else />
                                    </template>
                                </span>

                                <span class="text-white font-bold ml-2 text-md">{{ player.rating }}</span>
                            </span>
                        </p>
                    </div>
                </div>
