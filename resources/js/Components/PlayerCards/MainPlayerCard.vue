                ...
                <div class="flex justify-start mb-2" :class="{ 'space-x-2': size == 'sm', 'space-x-8': size == 'lg' }">
                    <div class="relative">
                        <Link :href="route('profile.edit')" v-if="isCurrentUser"
                            class="absolute bottom-0 right-0 p-1 bg-white rounded-full text-stone-800 hover:text-primary">
            ...
            <div class="grid gap-4 border-b"
                ...
                <div v-if="size == 'lg'" class="relative">
                    <p class="text-xs text-center"
                        :class="state == 'Free' ? 'text-white text-light opacity-50' : 'text-primary'">Favorite Club</p>
                ...
                <div>
                    <p class="text-xs text-center"
                        :class="state == 'Free' ? 'text-white text-light opacity-50' : 'text-primary'">Age</p>
                    <p class="text-sm text-center font-semi-bold">{{ player.age }}</p>
                </div>
                <div>
                    <p class="text-xs text-center "
                        :class="state == 'Free' ? 'text-white text-light opacity-50' : 'text-primary'">Played</p>
                    <p class="text-sm text-center font-semi-bold">0</p>
                </div>
                <div>
                    <p class="text-xs text-center"
                        :class="state == 'Free' ? 'text-white text-light opacity-50' : 'text-primary'">Missed</p>
                    <p class="text-sm text-center font-semi-bold">0</p>
                </div>
                <div>
                    <p class="text-xs text-center"
                        :class="state == 'Free' ? 'text-white text-light opacity-50' : 'text-primary'">Position</p>
