...
import { HeartIcon, PencilIcon, StarIcon as StarIconFilled } from '@heroicons/vue/20/solid'
        ...
        <div class="p-4">
            ...
            <div class="flex items-center justify-between gap-1 mt-2 sm:text-xs" :class="`text-${txtColor}`">
                <div class="flex items-center gap-1">
                    <a :href="'https://maps.google.com/?q=' + player.current_latitude + ',' + player.current_longitude"
                ...
                <div class="flex items-center gap-4">
                    <div class="flex space-x-2 bg-transparent" v-if="showInvite && player.id !== $page.props.auth.user.id">
                        <Link :href="route('invitation.create', player.id)"
                            class="text-sm scale-[0.85]  ltr:origin-left rtl:origin-right">{{ $t('send-invitation') }}
                    ...
                    <div class="relative">
                        ...
                        <span
                            class="bg-black text-white text-[10px] font-bold rounded absolute ltr:left-[-570%] rtl:right-[-520%] bottom-0 -my-4 p-1 whitespace-nowrap" v-if="copiedMsg">{{
