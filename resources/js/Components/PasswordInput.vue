...
<template>
    <div class="relative mt-1 rounded-md">
        <input ref="input" :type="type" :value="modelValue" :placeholder="placeholder"
            class="removeEyeIcon block w-full rounded-full border-gray-300 px-4 shadow-sm focus:border-primary focus:ring-primary sm:text-sm disabled:bg-gray-100"
