			...
			<button
				...
				<span
					...
					<img
						...
						alt=""
						class="h-6 w-6 flex-shrink-0 rounded cursor-pointer"
				...
				<span
					class="cursor-pointer absolute inset-y-0 ltr:right-0 rtl:left-0 mie-3 flex items-center pr-2"
					@click="showDropDown = !showDropDown">
				...
				<ul
					...
					<li
						...
						<div class="flex items-center">
							...
							<span
								class="font-normal mis-3 block truncate"
								:class="{
						...
						<span
							...
							:class="{
								...
								'text-white': option[valueName] != selected[valueName],
							}">
