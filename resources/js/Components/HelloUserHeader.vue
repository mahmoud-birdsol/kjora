...
<template>
    ...
    <div ref="container" class="container flex items-center w-[calc(100vw-3rem)] md:w-full">
        <p ref="userName" class="font-bold name whitespace-nowrap text-7xl">{{ $page.props.auth.user.name }}</p>
    </div>
