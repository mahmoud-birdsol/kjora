...
<template>
    ...
    <p class="text-7xl font-bold">{{ $page.props.auth.user.first_name }} {{ $page.props.auth.user.last_name }}</p>
    <p class="text-base font-semibold">{{ dayjs().locale(localei18n).format('dddd, DD MMMM YYYY') }}</p>
</template>
