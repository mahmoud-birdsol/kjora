...
<template>
    <teleport to="body">
        <FadeInTransition>
            <div
                v-show="show"
                class="fixed inset-0 transition-all duration-300 transform cursor-pointer"
                @click="close"
            >
        ...
        >
            <div
                v-show="show"
                class="fixed inset-0 grid max-w-xl mx-auto transition-all transform place-items-center"
            >
                <div
                ...
                >
                    ...
                    <div class="flex items-center justify-center w-full">
                        ...
                        />
                        <div
                            class="relative grid w-full grid-cols-1 gap-4 my-8"
                        >
                            <video
                                v-show="
                                    cameraIsOpen && !loadingCamera && !captured
                                "
                                ref="camera"
                                class="-scale-x-100"
                            ...
                            <div
                                v-if="cameraIsOpen && loadingCamera"
                            ...
                            >
                                <font-awesome-icon
                                    icon="spinner"
                                    spin
                                    class="w-5 h-5 text-center text-gray-500"
                                />
                            </div>
                            <canvas
                                v-show="captured"
                            ...
                            <button
                                v-if="captured"
                                @click="showCropModal"
                                class="absolute top-0 left-0 p-2 bg-white w-fit"
                            >
                                <CropIcon class="w-4" />
                            </button>
                            <Crop
                            ...
                            <div class="flex justify-center">
                                <button
                                    ...
                                    @click.prevent="
                                        cameraIsOpen ? capture() : openCamera()
                                    "
                                >
                                    <font-awesome-icon
                                        icon="camera"
