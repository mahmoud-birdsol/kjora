               ...
               <div class="px-4 my-6">
                  ...
                  <div class="py-1 border border-white rounded-full">
                     <el-slider
                        ...
                        :max="5"
                        @change="
                           form.ratingFrom = rating[0];
                           form.ratingTo = rating[1];
                        "
                     />
                  </div>
               </div>
