				...
				<div class="flex flex-col gap-3">
					...
					<div class="flex flex-col gap-0 text-center">
						<Link :href="route('player.profile', review.player.id)">
							<h3 class="text-lg font-bold capitalize text-primary">
								{{ review.player.name }}
							</h3>
						</Link>
						<Link :href="route('player.profile', review.player.id)"
							...
							<div class="flex flex-col gap-2">
								<div class="flex justify-between">
									...
									<span class="text-sm font-bold text-primary">{{
										ratingForm.ratingCategory.filter((c) => c.id === item.id)[0]
											.value
									}}</span>
								</div>
								<div
			...
			<div class="bg-white rounded-xl p-6 md:min-h-[300px]">
				<div
					...
					<div class="text-center">
						<p class="">
							{{ $t('thank you for sharing your experience with us') }}.
						</p>
						<p class="">
							{{
								$t('we appreciate you taking the time to share your rating')
							}}.
						</p>
					</div>
