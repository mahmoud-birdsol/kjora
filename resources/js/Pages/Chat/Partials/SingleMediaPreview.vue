...
<template>
   <div
      :class="isCurrentUser ? 'text-white' : 'text-stone-800'"
   ...
   >
      ...
      >
         <img
            class="object-contain max-w-full w-52"
      ...
      >
         <video
            :src="media.original_url"
            controls
            class="object-contain w-full h-full max-w-full"
         ></video>
      </div>
      <div
         v-else-if="
      ...
      >
         <div class="flex gap-1">
            ...
            />
            <img
               v-if="media?.mime_type.startsWith('application/pdf')"
               class="object-contain w-7 h-7"
               src="/images/pdf.png"
            />
            <p class="truncate text-start max-w-[15ch]">
               {{ media.file_name }}
            </p>
         </div>
