                    ...
                    <template #body>
                        <div class="flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <MoreBtn
                                    :url="route('terms.and.condition.index')"
                                    >{{ $t("terms-of-service") }}</MoreBtn
                                >
                            </div>
                            <div>
                                <InputLabel color="black">{{
                                ...
                                <MoreBtn :url="route('privacy.policy.index')">
                                    {{ $t("privacy-policy") }}</MoreBtn
                                >
                            </div>
                            <div>
                                <InputLabel color="black">{{
                                ...
                                <MoreBtn :url="route('cookies.policy.index')">
                                    {{ $t("cookie-use") }}</MoreBtn
                                >
                            </div>
                            <div>
                                <InputLabel color="black">{{
                    ...
                    <template #body>
                        <div class="flex flex-col gap-4">
                            <div>
                                ...
                                <MoreBtn :url="route('username.edit')">{{
                                    $t("update username")
                                }}</MoreBtn>
                            </div>
                            <div>
                                ...
                                <MoreBtn :url="route('password.edit')">{{
                                    $t("update-password")
                                }}</MoreBtn>
                            </div>
                            <div>
