			...
			<Card v-loading="loading">
				<CardContent :title="$t('subscribe')">
					...
					<template #body>
						...
						<div class="my-3 text-sm font-bold text-gray-600 uppercase">
							{{ $t('choose plan') }}
						</div>
						<RadioGroup
							...
							<RadioGroupOption
								...
								<li class="flex items-center justify-between">
									...
									<CheckIcon
										...
										:class="
											form.payment_plan == 'monthly' ? 'visible' : 'invisible'
										" />
								</li>
							</RadioGroupOption>
							<RadioGroupOption
								...
								<li class="flex items-center justify-between">
									...
									<CheckIcon
										class="w-6 p-1 text-black rounded-full bg-golden"
										:class="
											form.payment_plan == 'yearly' ? 'visible' : 'invisible'
										" />
								</li>
							</RadioGroupOption>
						</RadioGroup>
						...
						<PrimaryButton
							class="my-3"
							@click="send"
							:disabled="!form.payment_plan | (state == 'Premium')"
						...
						<FadeInTransition
							...
							<div
								...
								<div class="flex justify-center py-6">
									<div class="text-white uppercase opacity-50">
										{{ $t('minimal features') }}
									</div>
								</div>
							</div>
