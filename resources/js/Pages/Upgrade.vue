        ...
        <div class="grid grid-cols-1 gap-8 my-5 md:grid-cols-2">
                        ...
                        <RadioGroup v-model="form.payment_plan" class="flex flex-col gap-2">
                            <RadioGroupOption v-slot="{ checked }" value="monthly"
                                ...
                                <li class="flex items-center justify-between">
                                    <span>$10</span>
                                    <CheckIcon class="w-6 p-1 text-black rounded-full bg-golden"
                                        :class="form.payment_plan == 'monthly' ? 'visible' : 'invisible'" />
                                </li>
                            </RadioGroupOption>
            ...
            <Card>
                <CardContent :title="$t('subscribe')" class="justify-start">
                    ...
                    <template #body>
                        <FadeInTransition enter-from-class="opacity-0" enter-to-class="opacity-100" enter-active-class="transition-all duration-200">
                            ...
                            <div class="relative w-full max-w-sm mx-auto text-sm text-black bg-no-repeat bg-cover" v-else>
