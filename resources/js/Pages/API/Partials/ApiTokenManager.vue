    ...
    <div>
        ...
        <FormSection @submitted="createApiToken">
            ...
            <template #form>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <TextInput id="name" v-model="createApiTokenForm.name" type="text" class="block w-full mt-1" autofocus />
                        ...
                        <div class="space-y-6">
                            <div v-for="token in tokens" :key="token.id" class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <button v-if="availablePermissions.length > 0" class="ml-6 text-sm text-gray-400 underline cursor-pointer"
        ...
        <DialogModal :show="managingPermissionsFor != null" @close="managingPermissionsFor = null">
            ...
            <template #footer>
                ...
                <PrimaryButton class="ml-3" :class="{ 'opacity-25': updateApiTokenForm.processing }" :disabled="updateApiTokenForm.processing"
        ...
        <ConfirmationModal :show="apiTokenBeingDeleted != null" @close="apiTokenBeingDeleted = null">
            ...
            <template #footer>
                ...
                <DangerButton class="ml-3" :class="{ 'opacity-25': deleteApiTokenForm.processing }" :disabled="deleteApiTokenForm.processing"
