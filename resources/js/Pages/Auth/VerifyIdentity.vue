...
onMounted(() => {
    if (usePage().props.auth.user.identity_front_image_url != null) {
        identityFrontImagePreview.value =
            usePage().props.auth.user.identity_front_image_url;
    }

    if (usePage().props.auth.user.identity_back_image_url != null) {
        identityBackImagePreview.value =
            usePage().props.auth.user.identity_back_image_url;
    }

    if (usePage().props.auth.user.identity_selfie_image_url != null) {
        identitySelfieImagePreview.value =
            usePage().props.auth.user.identity_selfie_image_url;
    }
});
...
const form = useForm({
    identity_issue_country:
        usePage().props.auth.user.identity_issue_country ?? "Kuwait",
                        ...
                        <div class="flex flex-col justify-between h-full">
                            <div class="min-h-[200px]">
                                ...
                                <div class="mt-4">
                                    ...
                                    <InputError
                                        class="mt-2"
                                        :message="
                                            form.errors.identity_issue_country
                                        "
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <MegaButton
                                        :active="
                                            form.identity_type == 'national_id'
                                        "
                                        @click="
                                            form.identity_type = 'national_id'
                                        "
                    ...
                    <template #body>
                        <div class="flex flex-col justify-between h-full gap-2">
                            <div class="min-h-[200px]">
                                <div>
                                    <h3
                                        class="mb-8 font-bold text-black uppercase"
                                    >
                                        {{ $t("take-selfie-photo") }}
                                    </h3>
                                </div>
                                <div>
                                    ...
                                    <InputError
                                        class="mt-2"
                                        :message="
                                            form.errors.identity_selfie_image
                                        "
                                    />
                                </div>
                                <div>
                                    <p
                                        class="mt-2 text-sm font-bold text-black"
                                    >
                                        {{
                                            $t(
                            ...
                            <div
                                class="grid grid-cols-1 gap-4 mt-10 sm:grid-cols-2"
                            >
                                <div>
                                    <MegaButton
                                        @click="
                                            showIdentityFrontImageModal = true
                                        "
                                    >
                                        <template #icon>
                                            <img
                                    ...
                                    <InputError
                                        class="mt-2"
                                        :message="
                                            form.errors.identity_front_image
                                        "
                                    />
                                </div>
                                ...
                                <div>
                                    <MegaButton
                                        @click="
                                            showIdentityBackImageModal = true
                                        "
                                    >
                                        <template #icon>
                                            <img
                                    ...
                                    <InputError
                                        class="mt-2"
                                        :message="
                                            form.errors.identity_back_image
                                        "
                                    />
                                </div>
                            </div>
