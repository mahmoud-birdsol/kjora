...
<template>
    ...
    <GuestLayout>
        <GuestTwoColumnLayout>
            <Card>
                <CardContent title="Forgot Password?">
                    <template #body>
                        <div class="flex justify-between h-full items-center">
                            <p class="text-xs text-center text-gary-900">
                    ...
                    <template #footer>
                        <div class="flex justify-center items-center">
                            <p class="text-xs text-gray-900 font-bold">
                                ...
                                <Link :href="route('login')" class="text-primary hover:text-primaryDark underline">Try
                                Signing In
                                </Link>
                            </p>
                        </div>
