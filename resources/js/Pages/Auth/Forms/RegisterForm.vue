    ...
    <form @submit.prevent="submit" @keypress.enter.exact.prevent="submit">
        ...
        <div class="grid grid-cols-1 gap-4 mt-12 tracking-tight sm:grid-cols-2 ">
            ...
            <div>
                ...
                <RichSelectInput source="/api/clubs" value-name="id" text-name="name" image-name="logo" :append="defaultClub" v-model="form.club_id" />
            ...
            <div class="sm:col-span-2">
                <div>
                    ...
                    <TextInput type="text" v-model="form.username" placeholder="username" auto-complete="username" aria-required="true" />
