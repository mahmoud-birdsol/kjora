...
const tabs = computed(() => {
    return [
        ...
        },
        {
            ...
            compProps: { user: props.player, posts: props.posts },
        },
    ];
});
...
<template>
    <Head title="Home">
        ...
        <meta
            ...
            :content="`this is profile of ${player.name} on kjora website `"
        />
        <meta
            property="og:image"
            :content="player.avatar_url ?? 'images/logo.png'"
        />
    </Head>
    <AppLayout title="Home">
        ...
        <div class="py-12">
            <div
                class="flex flex-col max-w-5xl mx-auto gap-y-6 sm:px-6 lg:px-8"
            >
                <MainPlayerCard
                    :player="player"
                    size="lg"
                ...
                />
                <div
                    class="flex justify-center p-2 bg-white rounded-full gap-x-3"
                >
