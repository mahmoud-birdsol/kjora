        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="flex gap-4 my-8 overflow-x-auto hideScrollBar">
                    <button @click="filterByPosition(null)" class="py-2 px-4  w-full text-center items-center bg-white border-2 border-gray-300 rounded-full text-sm  text-gray-700 uppercase tracking-widest shadow-sm hover:text-gray-500 focus:outline-none focus:border-primary active:text-gray-800 active:bg-gray-50 disabled:opacity-25 transition whitespace-nowrap"
                    ...
                    <template v-for="position in positions" :key="position.id">
                        <button @click="filterByPosition(position.id)" class="py-2 px-4 w-full text-center items-center bg-white border-2 border-gray-300 rounded-full  text-sm  text-gray-700 uppercase tracking-widest shadow-sm hover:text-gray-500 focus:outline-none focus:border-primary   active:text-gray-800 active:bg-gray-50 disabled:opacity-25 transition whitespace-nowrap">
                            <span class="w-full text-center"
